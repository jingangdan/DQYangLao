...
//                BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher));
        ...
        // 设置圆形的填充颜色
        myLocationStyle.radiusFillColor(getResources().getColor(R.color.main_color));
    ...
    private void drawFence(GeoFence fence) {
        switch (fence.getType()) {
            ...
            case GeoFence.TYPE_DISTRICT:
                System.out.println("绘画模式 = TYPE_DISTRICT = ");
                drawPolygon(fence);
                break;
            default:
                break;
    ...
    private void addRoundFence() {
        DPoint centerPoint = new DPoint(39.92440396068655,
                116.39845937490463);
        fenceRadius = Float.parseFloat("50000");
