...
import com.dq.yanglao.base.CheckPermissionsActivity;
...
public class MainActivity2 extends CheckPermissionsActivity implements
        LocationSource,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBaseContentView(R.layout.fm_location);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.ivFootprint:
                ...
                View contentView = LayoutInflater.from(this).inflate(R.layout.dialog_hp_footprint, null);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.buttom1:
                ToastUtils.getInstance(this).showMessage("aaaaa");
                break;
