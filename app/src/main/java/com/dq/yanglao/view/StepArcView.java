...
public class StepArcView extends View {
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.bg1));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(getResources().getColor(R.color.bg1));
    ...
    private void drawTextStepString(Canvas canvas, float centerX) {
        ...
        canvas.drawText(text, centerX, getHeight() / 2 + bounds.height() + getFontHeight(numberTextSize), vTextPaint);
    }
